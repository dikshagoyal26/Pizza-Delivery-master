...
export const getMonthlySales = () => dispatch => {
  axios
    .get("http://localhost:5000/admin/sales/month")
    .then(res => {
      if (res.data) {
        dispatch({
...
export const getProductWiseSales = () => dispatch => {
  axios
    .get("http://localhost:5000/admin/sales/product")
    .then(res => {
      if (res.data) {
        dispatch({
...
export const getUserCount = () => dispatch => {
  axios
    .get("http://localhost:5000/admin/sales/countusers")
    .then(res => {
      if (res.data) {
        dispatch({
          type: GET_USER_COUNT,
...
export const getProductCount = () => dispatch => {
  axios
    .get("http://localhost:5000/admin/sales/countproducts")
    .then(res => {
      if (res.data) {
        dispatch({
